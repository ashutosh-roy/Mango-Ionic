...
let AuthService = class AuthService {
    ...
    getUserData() {
        this.storageService.get(_config_auth_constants__WEBPACK_IMPORTED_MODULE_1__["AuthConstants"].AUTH).then(res => {
    ...
    logout() {
        this.storageService.removeStorageItem(_config_auth_constants__WEBPACK_IMPORTED_MODULE_1__["AuthConstants"].AUTH).then(res => {
            this.userData$.next('');
